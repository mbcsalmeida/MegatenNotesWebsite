### These notes are for the Playstation version of Shin Megami Tensei. This route can be used for the SFC and GBA versions of the game, but it's considerably slower and riskier. Both the original JP versions and the English Patched versions are allowed for runs.
...
![Overworld Arcade](/images/smt1maps/2D/01-Arcade.png "Arcade") 

![Arcade](/images/smt1maps/3D/ARCADE-1F.png "Arcade")

Go to arcade for event. Return home and go to sleep.

- Heroine - SPD til 9, MAG til 19

![Overworld Kichijoji](/images/smt1maps/2D/02-InokashiraPark.png "Kichijoji") 

![Inokashira Park](/images/smt1maps/3D/INOKASHIRA-PARK-1F.png "Inokashira Park")

Buy 3 *Hamayas*, get the 400 mag.

![Overworld Kichijoji to Hospital](/images/smt1maps/2D/02-InokashiraPark.png "Kichijoji")

![Hospital](/images/smt1maps/3D/HOSPITAL-1F.png "Hospital") 

![Hospital 2F](/images/smt1maps/3D/HOSPITAL-2F.png "Hospital 2F")
...
![Overworld Hospital to Arcade](/images/smt1maps/2D/03-Arcade.png "Arcade")
...
![Shinjuku Underground Mall](/images/smt1maps/2D/04-Shinjuku-Mall.png) 
...
![Shinjuku Underground Mall](/images/smt1maps/2D/05-Tokyo-Government.png)
...
![Shinjuku Underground Mall](/images/smt1maps/2D/06-Ozawa-Hideout.png) 

![Ozawa's Building](/images/smt1maps/3D/OZAWA-BUILDING-1F.png)
...
Unequip all of Chaos Hero's equipment and put it on the Hero.

![Shinjuku B1F](/images/smt1maps/3D/SHINJUKU-B1F-3.png)

Unequip the Heroine's gun and bullets.

![Path to Ichigaya Garrison](/images/smt1maps/2D/07-Ichigaya.png)

![Ichigaya Garrison 1F](/images/smt1maps/3D/ICHIGAYA-1F.png) 

Take elevator to 3F, talk to Gotou.

![Ichigaya Garrison 3F](/images/smt1maps/3D/ICHIGAYA-3F.png)
...
Get Money chest and MAG Incense chest. Then go downstairs and grab Magic Incense.
...
Get money by talking to demons (+5000 Macca). Recruit a Messian Temple Knight/ Fanatic.

![Path to Shibuya](/images/smt1maps/2D/17-Shibuya.png) 

![Shibuya 1F](/images/smt1maps/3D/SHIBUYA-1F.png) 

![Shibuya 2F](/images/smt1maps/3D/SHIBUYA-2F-PSX.png)
...
Talk to the Heroine in the 2F and collect the gems. Then head to the terminal and transfer to Shinjuku.

![Shinjuku Mall](/images/smt1maps/3D/SHINJUKU2-B1F-2.png) 

![Shinjuku Underground](/images/smt1maps/3D/SHINJUKU2-B2F.png)
...
Save at terminal. After Alice event (B) go downstairs.
...
Talk to Alice (C). Say NO to Alice. Say YES to Yuriko.
...
![Roppongi Maps](/images/smt1maps/2D/10-Roppongi-2.png "Roppongi")
...
Fight Ladon:
- Hero - Attack; Heroine - Zionga; Kushinada-Hime: Attack; Goblin - Tarukaja
1. Hero - STR
2. Heroine - 2 MAG, 2 VIT

Traesto and leave.

![Ueno Maps](/images/smt1maps/2D/14-Ueno-Restored.png "Ueno")
...
![TDL Maps](/images/smt1maps/2D/TDL.png "TDL")
...
Traport and transfer to Ginza.

![GINZA B1F](/images/smt1maps/3D/GINZA-B1F-PSX-2.png)

Weapon Store:
- Sell - Magicians Mask, all armor except Sky Heels
- Buy - SPAS-12 to Heroine

Armor Store, buy:
- Hero - Dark Crown, Tetrajama, Atlas Bracers, Metal Boots
- Heroine - Ogre Helmet, Tetrajama, Ogre Bracers
...
Talk to Haniel, say YES. Traesto.

---
## Tokyo Government Building
---

![Cathedral Maps](/images/smt1maps/2D/17-Cathedral-Law.png "Cathedral")

![CATHEDRAL-1F](/images/smt1maps/3D/CATHEDRAL-1F-LAW.png) 

Enter the Cathedral and talk to Law Hero. Obtain the Octopus. 

Head outside and walk into the water. Then head back inside and talk to Law Hero again. 

Head to the Tokyo Government Building. Step outside and swim all the way to the left and then up to a tall building.
...
Traport. Summon Kushinada-Hime. Head through the right elevator.
...
![CATHEDRAL-3F](/images/smt1maps/3D/CATHEDRAL-3F-LAW.png)
