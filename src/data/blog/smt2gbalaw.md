...
tags:
  - smt2
description: Shin Megami Tensei II (GBA) - Law Glitchless notes.
---
...
- Text Speed - FAST
- Battle Repeat - Mode 2
- Animation - OFF

Time starts on NEW GAME.
...
Head east to the last room and name Zayin.
...
![Colosseum](@/assets/images/smt2maps/COLOSSEUM2.png)

Take the stairs up and mash through the announcer's speech.

Recruit Slave `スレイヴ`, Oracles `オラクルス` and/or Spartan `スパルタン`. You need at least two before fighting Red Bear.

Pick up the Fritz Helm `フリッツヘルム` (1), Legger Slum `レッガースラム` (2), Guyser Armor `カイザーアーマー` (3). Now you can defeat encounters to level up to level 9 - assign point to SPD `すばやさ`. After that, on any hero level up, assing points to INT. Afterwards, pick up Slicer `スライサー` (5) and equip everything.

Still grab the Gun (07) for extra money.

At NEW MOON or HALF MOON enter the fight. Name Daleth.

Fight Red Bear.

- AUTO

![HANEDABUILDING](@/assets/images/smt2maps/HANEDABUILDING.png)
...
Name Beth. Say Yes `はい` and get Cerberus. Leave.

Near the entrance to the bridge, recruit Fairy High Pixie `ヨウセイ ハイピクシー`. AUTO any other enemy. Head inside the bridge and head to the Slum City.
...
Unequip Hiroko's Sword, Gun and Bullets and enter the Mansion. If needed drop any weapon drops to be able to remove Hiroko's Sword!

Name the interesting hair guy (it's us).
...
Transfer to Valhalla.

Head to the underground passaga and head to the Heretic Mansion:

- Demonoid x Demonoid - Earthys
- Cait Sith x High Pixie - Heqet

Summon Heqet and Earthys. Traport and heal at the church. Leave the center.

### Basilisk

![Center](@/assets/images/smt2maps/CENTER-1.png) ![Holy Town Passage](@/assets/images/smt2maps/PASSAGE-HT.png)

Grab the chest - a Gold Pill `きんだん`. Put code (0352).

Formation: Beth, Aleph, -, Earthys, Heqet, -.

Unequip Gun and Bullets on Beth and equip the whip `さそりムチ`. Equip Beth's armor on Aleph. Leave.
...
- If Earthys dies, you can revive it afterwards with the Gold Pill
- Don't let both Heqet and Earthys die
- Points: Hero - INT (if >9, SPD), Beth - SPD.

You can start escaping from encounters. If you're low on money (under 4k) then you can defeat them by attacking with everybody except for Jack Frost who is more vulnerable

### King Frost

Summon Jack Frost before the King Frost fight if you have it.

Formation: Messian, Hawk, (Jack Frost), Earthys, Heqet, -.
...
Grab money chest (02). Put code (6191). Leave to Factory.
...
Go to church to bookmark the terminal. Go to the ranch.
...
- First turn: Aleph - Gun; Beth - Media; Jack Frost - Rakukaja; Heqet - Attack; Earthys - Tarukaja
- AUTO

If you still don't have the Sapphire, use Traestro, advance moon to Full Moon and grab it. Return Earthys and Jack Frost and Traport.
...
Summon Unicorn before the fight. Fight Daleth:

- 1 Formation: Aleph, Unicorn, Beth, Heqet, Earthys, -
- First turn: Gun, Attack, Attack, Media, Tarukaja
- Heal Aleph after the cutscene with any Beads or Healing items. If you don't have any, pray I guess.
- Then Gun, Attack, Attack, Media, Tarukaja
...
Heal at the Gaia. Put Codes (9192) -> (1213) -> (1834). Pay attention to MP consumption.
...
Go back and heal at the Gaia again.
...
- AUTO
- Heal with Earthys Diarama if needed.
...
Talk to Zayin. Turn back around and get Cerberus. If any of the demons are dead, summon it and revive with Samarecarm. Head outside to the center. Take the passage to Holy Town.

### Holy Town

![Holy Town](@/assets/images/smt2maps/HOLYTOWN-2.png) ![Holy Town](@/assets/images/smt2maps/HOLYTOWN-TE.png)

Watch Zayin speak in the TV.

![Holy Town](@/assets/images/smt2maps/HOLYTOWN-TE.png) ![Holy Town](@/assets/images/smt2maps/HOLYTOWN-3.png)

Enter through the west entrance of Holy Town. Recover at the Garage if needed. Bookmark the Terminal. Traesto. Estoma.

![Grand Church](@/assets/images/smt2maps/GRANDCHURCH-2.png) ![Grand Church](@/assets/images/smt2maps/GRANDCHURCH-23F.png)

Enter the Grand Church on 6/8 Ascending. If you're low on money grab the the other treasure chest (1) for 738 makka. Get Topaz. Head to 3F. Summon Cerberus and revive any dead demons before the fight.
...
![Underground](@/assets/images/smt2maps/UNDERGROUND-7.png)
...
- Cerberus x Unicorn x Sudama = Naragiri
